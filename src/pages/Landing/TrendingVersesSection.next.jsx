        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((item) => (
            <article
              ...
              className="card-surface cursor-pointer rounded-2xl p-5 transition hover:-translate-y-1 hover:shadow-xl"
            >
              ...
              <p className="mt-2 text-sm text-muted">
                {item.readCount} {t?.("home.trending_listens")} • {item.bookmarkCount} {t?.("home.trending_bookmarks")}
              </p>
            </article>
          ))}
        </div>
